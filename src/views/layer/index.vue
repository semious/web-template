<template>
  <a-layout class="container">
    ...
    <BasicInfo :styleId="styleId" @addUser="addUser" ref="basicInfoRef" v-show="showDetail"
    ...
    <a-space style="margin-top: 12px;" v-show="showDetail">
      <div class="psb-box">
        ...
        <a-table style="width: 1000px;margin-top: 18px;" :columns="psbColumns" :data="psbData" :pagination="false"
          :bordered="{wrapper: true, cell: true}">

          <template #optional="{ record }">
            <a-space>
              <a-button type="text" size="small" @click="viewLayer(record)">查看图层</a-button>
    ...
    <a-space style="margin-top: 20px;margin-left: 24px;">
      <a-space>
        <a-button type="text" size="small" @click="checkAll">全选</a-button>
    ...
    <a-space class="img-box">
      <div class="img-item" v-for="(item,i) in layerList" :key="i" @click="checkItem(i)">
        <i class="check-i" v-if="hasCheck(i)"> <icon-check class="check" /></i>
        <a-image width="118" height="70" :src="item.imgSrc" :preview="false" />
    ...
    <StyleAdd :userTitle="userTitle" :visibleAdd="visibleAdd" @closeDrawer="closeDrawer" :isModify="isModify">
    </StyleAdd>
  </a-layout>
</template>
<script lang="ts" setup>
  ...
  import { getLayerList, getPartionListByStyleId, getLayerByPartionId, partionSplit } from "@/api/style";
