  ...
  <Layout active="3">
    <template #content>
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>咨询套餐</el-breadcrumb-item>
      </el-breadcrumb>
      <a-layout>
...
import { getConsultProductInfo, updatesProductInfo, addProductInfo } from "@/api/product";
...
export default {
  ...
  setup() {
    ...
    function getDataByPage(page: number) {
      ...
      curPage.value = page;
      getConsultProductInfo(page, currentStatus.value).then((res: any) => {
    ...
    function validateInfo(record: any) {
      const { product_name, product_introduce, product_sort, product_price } = record;
